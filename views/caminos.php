...
<section class="section-slide bg0 p-t-104 p-b-116">
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/pozo.jpg); ">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/puerta.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(255,255,255)">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/tunel.png); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(255,255,255)">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/ciudad.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(255,255,255)">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/ruta2.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(255,255,255)">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-control" id="inlineFormCustomSelect">
                                    ...
                                    <option value="1"> Pozos Naturales</option>
                                    <option value="2"> Puente de Orion</option>
                                    <option value="3">Túneles Naturales</option>
                                    <option value="4">Ciudad de Piedra</option>
                                </select>
