...
<section class="section-slide bg0 p-t-104 p-b-116">
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/rupestre.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(25,25,25)">
                                Ruta 1 - Técnico en Operación Turística
                            </span>
                        </div>
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/rupestreG.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(25,25,25)">
                                Ruta 2 - Técnico en Operación Turística
                            </span>
                        </div>

                        <div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
                            <h2 class="ltext-104 cl2 p-t-19 p-b-43 respon1 " style="color:rgb(25,25,25)">
                                Pinturas Rupestres Raudal del Guayabero
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/rupestreAzul.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(25,25,25)">
                                Ruta 3 - Técnico en Operación Turística
                            </span>
                        </div>
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/azul.png); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(25,25,25)">
            ...
            <div class="item-slick1" style="background-image: url(<?= base_url ?>views/images/ruta1.jpg); ">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-102 cl2 respon2" style="color:rgb(25,25,25)">
